...
export const productCatalog = [
  ...
  {
    id: 'PC-01',
    name: 'Premium Micro-topping Flooring',
    category: 'Civil Works',
    unit: 'sq. ft',
    rate: 15,
    description: 'Seamless decorative micro-cement flooring finish for high-traffic interiors.',
  },
  {
    id: 'PC-02',
    name: 'Anti-bacterial Wall Prep',
    category: 'Civil Works',
    unit: 'sq. ft',
    rate: 2.5,
    description: 'Antimicrobial primer coat applied to walls prior to painting or cladding.',
  },
  {
    id: 'PC-03',
    ...
    unit: 'L.S.',
    rate: 4200,
    description: 'Load-bearing wall alterations and reinforcement as per structural drawings.',
  },
  {
    id: 'PC-04',
    ...
    unit: 'sq. ft',
    rate: 8.5,
    description: 'Suspended gypsum board ceiling with recessed lighting provisions.',
  },
  {
    id: 'PC-05',
    ...
    unit: 'sq. ft',
    rate: 6,
    description: 'Membrane-based waterproofing for wet areas, terraces, and balconies.',
  },
  {
    id: 'PC-06',
    name: 'Partition Wall (Drywall)',
    category: 'Civil Works',
    unit: 'sq. ft',
    rate: 9.5,
    description: 'Metal-stud drywall partition with acoustic insulation infill.',
  },

  // Electrical
  {
    id: 'PC-07',
    name: 'IoT Backbone Integration',
    category: 'Electrical',
    unit: 'Set',
    rate: 3500,
    description: 'Structured wiring and hub setup enabling whole-home smart device control.',
  },
  {
    id: 'PC-08',
    name: 'Smart Ambient Lighting System',
    category: 'Electrical',
    unit: 'Zone',
    rate: 120,
    description: 'Dimmable, app-controlled LED lighting configured per zone.',
  },
  {
    id: 'PC-09',
    name: 'EV Charging Point Infrastructure',
    category: 'Electrical',
    unit: 'Unit',
    rate: 1850,
    description: 'Dedicated circuit and wall-mounted charger for electric vehicles.',
  },
  {
    id: 'PC-10',
    name: 'Point Wiring & Conduit',
    category: 'Electrical',
    unit: 'Point',
    rate: 45,
    description: 'Concealed conduit wiring for a single switch, socket, or light point.',
  },
  {
    id: 'PC-11',
    name: 'DB Panel Upgrade',
    category: 'Electrical',
    unit: 'Unit',
    rate: 950,
    description: 'Distribution board replacement with MCB/RCCB protection.',
  },
  {
    id: 'PC-12',
    ...
    unit: 'Set',
    rate: 2600,
    description: 'Rooftop mounting structure and wiring for solar panel arrays.',
  },

  // Plumbing
  {
    id: 'PC-13',
    name: 'CPVC Piping Installation',
    category: 'Plumbing',
    unit: 'Point',
    rate: 55,
    description: 'Concealed CPVC water supply piping for a single fixture point.',
  },
  {
    id: 'PC-14',
    name: 'Water Purifier Plumbing',
    category: 'Plumbing',
    unit: 'Unit',
    rate: 400,
    description: 'Dedicated supply and drain line for under-sink water purifiers.',
  },
  {
    id: 'PC-15',
    ...
    unit: 'Set',
    rate: 1200,
    description: 'Supply, fitting, and sealing of washbasin, WC, and shower fixtures.',
  },
  {
    id: 'PC-16',
    name: 'Overhead Water Tank Setup',
    category: 'Plumbing',
    unit: 'Unit',
    rate: 3200,
    description: 'Tank installation with inlet/outlet piping and float valve.',
  },
  ...
  // HVAC
  {
    ...
    unit: 'Unit',
    rate: 1800,
    description: 'Indoor/outdoor unit mounting with copper piping and drain line.',
  },
  {
    id: 'PC-18',
    name: 'Duct Ventilation System',
    category: 'HVAC',
    unit: 'sq. ft',
    rate: 22,
    description: 'Insulated ductwork for centralized air distribution.',
  },
  {
    id: 'PC-19',
    ...
    unit: 'Unit',
    rate: 250,
    description: 'Wall or ceiling mounted exhaust fan with wiring.',
  },

  // Furniture & Finishes
  {
    id: 'PC-20',
    name: 'Modular Kitchen (HDF)',
    category: 'Furniture & Finishes',
    unit: 'Unit',
    rate: 14200,
    description: 'Factory-finished HDF modular kitchen with fittings and countertop.',
  },
  {
    id: 'PC-21',
    ...
    unit: 'Unit',
    rate: 1500,
    description: 'Made-to-measure wardrobe with laminate finish and internal shelving.',
  },
  {
    id: 'PC-22',
    ...
    unit: 'Unit',
    rate: 2200,
    description: 'Wall-mounted TV console with decorative wood paneling.',
  },
  {
    id: 'PC-23',
    ...
    unit: 'Set',
    rate: 900,
    description: 'Curtains, cushions, and upholstery styled for a single room.',
  },
  {
    id: 'PC-24',
    name: 'Vinyl Flooring',
    ...
    unit: 'sq. ft',
    rate: 4.5,
    description: 'Click-lock luxury vinyl plank flooring for residential spaces.',
  },
  {
    id: 'PC-25',
    ...
    unit: 'sq. ft',
    rate: 3.2,
    description: 'Designer wallpaper supply and application including surface prep.',
  },
  ...
  // Services
  {
    ...
    unit: 'L.S.',
    rate: 12000,
    description: 'End-to-end interior design concept, layout, and material selection.',
  },
  {
    id: 'PC-27',
    name: 'Site Supervision (per month)',
    category: 'Services',
    unit: 'Month',
    rate: 1800,
    description: 'On-site execution oversight and quality checks by project supervisor.',
  },
  {
    id: 'PC-28',
    ...
    unit: 'Set',
    rate: 3500,
    description: 'Photorealistic 3D renders of proposed interior spaces.',
  },
  {
    id: 'PC-29',
    ...
    unit: 'Month',
    rate: 600,
    description: 'Scheduled maintenance visits for a fixed period after project completion.',
  },
]
